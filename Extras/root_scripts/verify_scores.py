...
def test_visual_scores_for_fuzzy():
    ...
    try:
        ...
        # Disable LLM parsing for faster diagnostics
        results_data = mm_search.search_with_fallback(
            "oil rig", top_k=5, use_llm=False, facet="auto"
        )
        ...
        for i, r in enumerate(results):
            ...
            if r.vision_score == 0:
                print("    [WARN] Vision score is ZERO")
            if r.text_score == 0:
                print("    [WARN] Text score is ZERO")
